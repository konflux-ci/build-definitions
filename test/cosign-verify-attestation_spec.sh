...
Describe 'cosign-verify-attestation'
...
-----END PUBLIC KEY-----'
    When call cosign-verify-attestation image_ref "${key}" output_file
  ...
  It 'handles cosign key references'
    When call cosign-verify-attestation image_ref k8s://default/testsecret output_file
