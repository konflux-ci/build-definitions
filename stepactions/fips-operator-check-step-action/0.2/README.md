...
This stepAction scans relatedImages of operator bundle image builds for FIPS compliance using the check-payload tool. Images are processed in parallel to improve performance.
