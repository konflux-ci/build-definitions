...
|PREFETCH_ROOT|The root directory of the artifacts under the prefetched directory. Will be kept in the npm tar as the top directory for all artifacts.|package|false|
