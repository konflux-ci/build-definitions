...
| RECORD_EXCLUDED              | Whether to record the excluded findings (defaults to false). If `true`, the the excluded findings will be stored in `excluded-findings.json`. | "false"
| IMAGE_DIGEST | Image digest that will be uploaded with ORAS control.                                                                                                  | | No                                                                                          | true       |
