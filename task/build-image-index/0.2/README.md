...
|ZSTD_IMAGES|Space-separated list of zstd:chunked Image Manifests to be included in the Image Index alongside gzip variants. When provided, must correspond 1:1 with IMAGES. Entries are added AFTER all gzip entries to ensure backward compatibility.|""|false|
