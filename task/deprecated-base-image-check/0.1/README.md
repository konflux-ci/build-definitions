# deprecated-base-image-check task

## Description:
The deprecated-base-image-check checks for deprecated images that are no longer maintained and prone to security issues.
