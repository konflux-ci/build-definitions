module github.com/konflux-ci/build-definitions/e2e-tests
...
replace (
	...
	github.com/go-chi/chi => github.com/go-chi/chi/v5 v5.3.0
	github.com/go-chi/chi/v5 => github.com/go-chi/chi/v5 v5.3.0
