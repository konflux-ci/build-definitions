...
|privileged-nested| Whether to enable privileged mode| false| build-container:0.4:PRIVILEGED_NESTED|
...
|PRIVILEGED_NESTED| Whether to enable privileged mode| false| '$(params.privileged-nested)'|
