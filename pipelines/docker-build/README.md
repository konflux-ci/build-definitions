...
|workspace| |False| clone-repository:0.1:output ; prefetch-dependencies:0.3:source ; build-container:0.10:source ; build-source-image:0.3:workspace ; sast-snyk-check:0.4:workspace ; sast-shell-check:0.1:workspace ; sast-unicode-check:0.4:workspace ; push-dockerfile:0.3:workspace|
