...
|output-image| Fully Qualified Output Image| None| build-container:0.9:IMAGE ; build-image-index:0.3:IMAGE|
...
|workspace| |False| clone-repository:0.1:output ; prefetch-dependencies:0.3:source ; build-container:0.9:source ; build-source-image:0.3:workspace ; sast-snyk-check:0.4:workspace ; sast-shell-check:0.1:workspace ; sast-unicode-check:0.4:workspace ; push-dockerfile:0.3:workspace|
