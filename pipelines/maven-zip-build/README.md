...
|workspace| |False| show-summary:0.2:workspace ; clone-repository:0.1:output ; prefetch-dependencies:0.2:source ; build-oci-artifact:0.1:source ; sast-snyk-check:0.4:workspace ; sast-coverity-check-build:0.4:source ; sast-coverity-check:0.4:source ; sast-shell-check:0.1:workspace ; sast-unicode-check:0.2:workspace|
