...
|image-expires-after| Image tag expiration time, time values could be something like 1h, 2d, 3w for hours, days, and weeks, respectively.| | clone-repository:0.2:ociArtifactExpiresAfter ; prefetch-dependencies:0.10:ociArtifactExpiresAfter ; build-images:0.10:IMAGE_EXPIRES_AFTER|
...
|output-image| Fully Qualified Output Image| None| clone-repository:0.2:ociStorage ; prefetch-dependencies:0.10:ociStorage ; build-images:0.10:IMAGE ; build-image-index:0.3:IMAGE|
