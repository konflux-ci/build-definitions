#!/usr/bin/env bash
# Runs cosign verify to verify the signature of the attestation for the
# provided image with the provided public key
# usage:
#   cosign-verify-attestation.sh <image reference> <public key> <output file>
# where:
...
cosign_verify_attestation "$1" "$2" "$3"
